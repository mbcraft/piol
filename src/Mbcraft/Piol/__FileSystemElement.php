...
namespace Mbcraft\Piol {
    ...
    abstract class __FileSystemElement extends PiolObject {
         ...
         * @internal
         */
        public function setPermissionsRwx($rwx_permissions) {
         ...
         * 
         * @return StorageDrivers\PropertiesStorage the properties storage for this element.
         * 
         * @api
         */
        ...
        /**
         * Sets the owner of this fs element.
         *
         * @param string $owner The owner name, as string
         */
        ...
        /**
         * Returns the owner of this file system element.
         *
         * @return string the owner user name
         */
        ...
        /**
         * Returns the group this file system element belongs to.
         *
         * @return string the string group name
         */
        ...
        /**
         * Sets the group owner of this file system element.
         *
        ...
        /**
         * Checks if a file system element has the specified permissions.
         *
         * @param string $perm_string The permission string
         *
         * @return true if the element has the specified permissions, false otherwise
         */
        abstract function hasPermissions($perm_string);
