...
namespace Mbcraft\Piol {
    ...
    class Dir extends __FileSystemElement {
         ...
         * 
         * @param string $name The name for this directory.
         * @return Dir The file instance.
         */
        ...
        /**
         * 
         * Deletes this folder and all its content, recursively.
         * 
        ...
        public function hasOnlyOneSubdir() {
            ...
            if (count($content[0]) == 0 && count($content[1]) == 1) {
                __FileSystemElement:$dir_elem = $content[1][0];
                if ($dir_elem->isDir())
                    return true;
            }
            return false;
